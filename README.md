...
- **Flexible Search Formatting (Input Normalization):** Implements additional correction for neutralizing added spaces and hyphen variances in memory, matching different punctuated names to its counterpart in database.
